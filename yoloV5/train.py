...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/yolov5m_class.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='expm', help='save to project/name')
